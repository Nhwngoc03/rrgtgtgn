  ...
  const mockBlindBoxes: BlindBox[] = [
    {
      ...
      description: 'Gói tươi được lựa chọn ngẫu nhiên từ nông sản dư thừa',
      quantity: 15,
      sold: 340,
    },
    {
      id: '2',
      name: 'Combo Củ Mix (7kg)',
      price: 119000,
      ...
      description: 'Mix các loại củ tươi ngon, chất lượng cao',
      quantity: 8,
      sold: 256,
    },
    {
    ...
    },
    {
      ...
      distance: '3.5 km',
      savedCount: 156,
      items: ['Hành lá', 'Tía tô'],
      description: 'Trái cây tươi ngon bảo quản tốt',
      quantity: 20,
      sold: 412,
    },
    {
      ...
      distance: '2.1 km',
      savedCount: 562,
      items: ['Nhiều loại củ', 'Trái cây mùa'],
      description: 'Gói tiết kiệm siêu lớn với 10kg nông sản mix đa dạng',
      quantity: 3,
      sold: 89,
    },
    {
      ...
      savedCount: 298,
      items: ['Hoa cải'],
      description: 'Củ sạch chứng chỉ VietGAP được chọn lựa kỹ càng',
      quantity: 12,
      sold: 278,
    },
  ];
